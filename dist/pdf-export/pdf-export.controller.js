...
let PdfExportController = class PdfExportController {
    ...
    async setters(from, to, archive, format, res) {
        if (format === 'html') {
    ...
    async closers(from, to, archive, format, res) {
        if (format === 'html') {
...
__decorate([
    ...
    __param(2, (0, common_1.Query)('archive')),
    __param(3, (0, common_1.Query)('format')),
    __param(4, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, Object, Object, Object]),
    __metadata("design:returntype", Promise)
], PdfExportController.prototype, "setters", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, Object, Object, Object]),
    __metadata("design:returntype", Promise)
], PdfExportController.prototype, "closers", null);
exports.PdfExportController = PdfExportController = __decorate([
    (0, common_1.Controller)('pdf-export'),
